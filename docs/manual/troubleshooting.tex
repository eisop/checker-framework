...
Line endings are managed automatically via the repository’s .gitattributes file. This ensures consistency between Windows and Unix-based systems. This achieves the same result as configuring core.autocrlf, but is tracked in version control and applies consistently to all contributors.
