...
lower bound is implicitly the bottom type \<NullType> (null type is a special \href{https://docs.oracle.com/javase/specs/jls/se24/html/jls-4.html#jls-4.1}{unnamed type}).
...
because \<null> is not a valid Java type.
