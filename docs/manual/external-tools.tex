...
Running the Checker Framework as an Error Prone plugin makes its findings into Error Prone
...
Prone at all) remains fully supported and behaves identically; choose whichever fits your
build.
...
with the same version as the other Checker Framework artifacts.
...
\end{Verbatim}
Several type systems can run together over a single compilation:
\begin{Verbatim}
...
Framework's own error-versus-warning distinction is preserved textually in each message.
