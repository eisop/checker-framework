...
\end{Verbatim}
This is an error whatever \<-Xep:eisopcf:> severity is in effect:  the severity scales
the importance of findings, and this is a statement that there will be none.  To have
