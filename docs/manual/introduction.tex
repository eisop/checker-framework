...
\item \<-AuseConservativeDefaultsForUncheckedCode>
  ...
  \end{itemize}
\item \<-AuseOptimisticDefaultsForUncheckedCode>
  Enables optimistic defaults, and suppresses all type-checking warnings in unchecked source code.
  ...
  A kind of code cannot use both optimistic and conservative defaults.
