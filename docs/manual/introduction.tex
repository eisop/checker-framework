...
\item \<-Amode=\emph{mode}>
  Enable a checker-defined group of options.  See the documentation for the checker to learn
  which modes it supports and which options each mode enables.  An explicitly supplied value for
  an individual option takes precedence over the value supplied by the mode.
\item \<-Alint>
...
% LocalWords:  AuseConservativeDefaultsForUncheckedCode AresolveReflection Ainfer Amode
