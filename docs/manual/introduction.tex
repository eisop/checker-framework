...
\item \<-Aaliases=\emph{aliases}>
  Lists the fully qualified path of the aliases, separated by new line. File should end with .alias.
  This enable user to define custom annotations to be treated as Checker Framework annotations.\item \<-Alint=>
  The name of the alias file should be the name of the Checker Framework annotation.
