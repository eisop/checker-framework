...
\item \<-AcheckRedundantAnnotations>
  Supplying this flag helps to reduce redundant annotations,
  program will issue a warning if the explicitly written annotation
