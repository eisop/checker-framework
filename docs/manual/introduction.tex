...
\item \<-AonlyAnnotatedFor>
  Suppress all errors and warnings for code outside the scope of \<@AnnotatedFor> and
  unsoundly use CLIMB default and suppresses the warnings outside the scope of a corresponding \<@AnnotatedFor> annotation.
