...
This can only be used for annotations without attributes, e.g. this will not be usable to declare an alias for @Regex(2).
When in a Unix system, `;` need to be escaped.
