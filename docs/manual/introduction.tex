...
object itself.  For example, the Tainting Checker permits declarations such as
\code{class UntaintedBuffer extends @Untainted Buffer}, where the annotation is
on \code{Buffer}.  Other checkers may reject annotations in that location.
