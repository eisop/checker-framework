...
\item
  ...
  % (\myurl{https://eisop.github.io/annotation-file-utilities/}).
...
\href{https://eisop.github.io/annotation-file-utilities/#insert-annotations-to-source}{\code{insert-annotations-to-source}
  script} from the
\href{https://eisop.github.io/annotation-file-utilities/}{Annotation
