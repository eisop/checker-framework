...
\<-AuseOptimisticDefaultsForUncheckedCode=source,bytecode> to trust code outside
a relevant \<@AnnotatedFor> scope.  This applies optimistic defaults (see
...
use both optimistic and conservative defaults.
