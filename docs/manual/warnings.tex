...
\item
  ...
  Such casts are unsafe, and they can break the property of the type system.
...
\item
  \code{instanceof:unsafe} (default: on) warn about unsafe instanceof pattern
  that are not checked at run time, as in \code{o instanceof @Untainted String}.
  Such instanceof patterns are unsafe, and they can break the property of the type system.
