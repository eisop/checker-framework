...
It can be combined with \code{-AuseOptimisticDefaultsForUncheckedCode=source}, which applies
optimistic defaults but does not suppress warnings by itself.
...
\code{@AnnotatedFor}, scoped to nullness checking with \code{applyToSubpackages = false},
