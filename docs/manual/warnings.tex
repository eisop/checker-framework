...
\code{-AuseConservativeDefaultsForUncheckedCode=source} and
\code{-AusePermissiveDefaultsForUncheckedCode=source},
which also apply conservative or permissive defaults for code outside the scope of an \code{@AnnotatedFor} annotation.
