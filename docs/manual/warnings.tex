...
\refqualclass{framework/qual}{UnannotatedFor}; see
...
The Nullness Checker's \code{-Amode=jspecify} is the closest equivalent:  it implies this
option and makes \code{@NullMarked} and \code{@NullUnmarked} act as \code{@AnnotatedFor} and
\code{@UnannotatedFor} (Section~\ref{nullness-jspecifyNullMarkedAlias}).
