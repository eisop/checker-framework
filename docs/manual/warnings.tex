...
\noindent
\<-AsuppressWarnings=text.parsing> suppresses all three.  Rather than suppressing
these warnings, it is usually better to generate the missing binary stub file, as
described in Sections~\ref{annotating-jdk} and~\ref{stub-distributing}.
