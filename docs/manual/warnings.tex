...
\code{-AuseOptimisticDefaultsForUncheckedCode=source},
which also apply conservative or optimistic defaults for code outside the scope of an \code{@AnnotatedFor} annotation.
