...
all inputs and return values satisfying every requirement.  They do not suppress warnings.  A kind
of code (\code{source} or \code{bytecode}) cannot use both optimistic and conservative defaults.
