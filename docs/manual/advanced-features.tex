...
try-with-resources construct, variables in \<for> statements, and exception
parameters in the \href{https://docs.oracle.com/javase/specs/jls/se17/html/jls-14.html#jls-Catches}{Java Language Specification}.
