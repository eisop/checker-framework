...
reasons.  They record which code its authors have annotated for which type
...
ones that instrument bytecode, read that information.  It is the authors'
claim, not a record that a checker was run:  \<javac> stores the annotation
whether or not any checker processed the code.
