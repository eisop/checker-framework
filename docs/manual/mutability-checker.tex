\htmlhr
\chapterAndLabel{Mutability Checker}{mutability-checker}
...
The Mutability Checker is useful for APIs that expose read-only references to objects, for classes
...
\sectionAndLabel{Mutability qualifiers}{mutability-qualifiers}

The main mutability type qualifiers are:

\begin{figure}
\includeimage{mutability}{8cm}
...
\label{fig-mutability-hierarchy}
\end{figure}
...
\sectionAndLabel{Class bounds and receiver-dependent mutability}{mutability-class-bounds}
...
\sectionAndLabel{Object creation}{mutability-object-creation}
...
\sectionAndLabel{Assignable fields}{mutability-assignable-fields}

The Mutability Checker distinguishes an object's abstract state from fields that may be
...
\sectionAndLabel{Implicitly immutable types}{mutability-implicitly-immutable-types}

The Mutability Checker treats primitive values, string literals, and common wrapper/value
...
that the Mutability Checker assigns to them.
