...
\<qual> can be in the same directory as your checker's source file or in a
separate directory. The Checker Framework automatically treats any annotation that
