...
However, it does not prevent the type system or framework from using the top or bottom qualifier for programmatic defaults (such as conservative defaults for unchecked code or optimistic defaults), because top and bottom qualifiers are inherently permitted for programmatic defaults.
