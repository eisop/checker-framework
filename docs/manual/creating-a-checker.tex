...
\<null> is the bottom type in the Java type hierarchy, and it is a special unnamed type.
Because the only value with type \<Void> is \<null>, Checker Framework uses the type \<Void> to represent the bottom type.
(The only exception
