...
The qualifiers should be in a \<qual> subpackage of the type checker subpackage -
that is the checker reflectively looks and the only thing that matters for that is the package name.
...
they should be distributable separately. The Checker Framework automatically treats any annotation that
