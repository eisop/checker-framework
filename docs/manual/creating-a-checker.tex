...
\multicolumn{2}{p{3\bw}|}{\centering \href{https://eisop.github.io/afu/annotation-file-utilities.html/}{Annotation File Utilities} \par (\code{.java} $\leftrightarrow$ \code{.class} files)}
\\ \hline
