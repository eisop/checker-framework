...
Define the options enabled by each mode by overriding \code{addOptionsForMode}:
...
% LocalWords:  pids jstack ctrl SupportedModes addOptionsForMode putIfAbsent Amode
