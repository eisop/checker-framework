...
(for example, options prefixed with \code{NullnessChecker_} apply to \code{NullnessNoInitSubchecker}).
A subchecker can override a parent option with a more specific prefix
(e.g., \code{-ANullnessNoInitSubchecker_lint=-redundantNullComparison}),
