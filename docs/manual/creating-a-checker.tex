...
\myurl{https://eisop.github.io/api/}.
...
\multicolumn{2}{p{3\bw}|}{\centering \href{https://eisop.github.io/annotation-file-utilities/}{Annotation File Utilities} \par (\code{.java} $\leftrightarrow$ \code{.class} files)}
\\ \hline
\multicolumn{8}{|p{8.5\bw}|}{\centering
  \href{https://eisop.github.io/jsr308/}{Java type annotations} syntax
...
\href{https://eisop.github.io/manual/checker-framework-dataflow-manual.pdf}{Dataflow
  Manual}.
