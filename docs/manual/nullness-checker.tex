...
element when invoked on a non-empty queue whose element type is \<@NonNull>.
...
or other side-effecting methods) conservatively reset this non-empty knowledge,
so subsequent poll operations will not be refined without another non-emptiness check.
