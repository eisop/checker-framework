...
\item[\refqualclass{checker/nullness/qual}{MonotonicNonNull}]
  ...
  the field a member field that is set in the constructor.  The Nullness Checker
  issues a warning for a \<static> field annotated \<@MonotonicNonNull>; suppress
  it with \<@SuppressWarnings("monotonic.on.static")>.
