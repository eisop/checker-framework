...
To suppress warnings by the Nullness Checker, the KeyFor Checker and the Initialization Checker,
use the \<@SuppressWarnings("nullness")> annotation.

To suppress warnings by the Nullness Checker and the KeyFor Checker without also suppressing warnings
by the Initialization Checker (see Section~\ref{initialization-checker}),
use the \<@SuppressWarnings("nullnessnoinit")> annotation.

To suppress warnings by the Nullness Checker and the Initialization Checker without also suppressing warnings
by the KeyFor Checker (see Section~\ref{map-key-checker}),
use the \<@SuppressWarnings("nullnessnokeyfor")> annotation.

To suppress warnings only by the Nullness Checker, use the \<@SuppressWarnings("nullnessonly")> annotation.

To suppress warnings only by the KeyFor Checker, use the \<@SuppressWarnings("keyfor")> annotation.

To suppress warnings only by the Initialization Checker, use the \<@SuppressWarnings("initialization")> annotation.
...
More suppress warnings prefixes combined with other checker are available at Section~\ref{suppressing-warnings-nullness}.
