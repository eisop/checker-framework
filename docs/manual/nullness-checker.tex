...
\item
  ...
  an empty inner class constructor has the enclosing expression type <@UnderInitialization> by default and will throw an error
  when being initialized, which is not necessary.
