  ...
  \begin{itemize}
    \item the argument has length 0:
      ...
      \begin{itemize}
        ...
        \item reference to a private, final, zero-length field array, e.g. \<c.toArray(EMPTY_STRING_ARRAY)>, where \<EMPTY_STRING_ARRAY> is initialized to \<new String[0]> (or an equivalent zero-length array expression).
      \end{itemize}
