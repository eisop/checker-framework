...
\item
  ...
  \code{org.jspecify.nullness.NullMarked} annotation is also supported.  An explicitly
  supplied value for an individual option takes precedence over \code{-AjspecifyMode}.
