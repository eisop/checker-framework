...
- The org.checkerframework.framework.qual.TypeQualifier{s} annotations are
  ...
  https://eisop.github.io/manual/#creating-indicating-supported-annotations .
...
import checkers.nullness.quals._;
to
import org.checkerframework.checker.nullness.qual._;
...
Documentation:
A new tutorial is available at https://eisop.github.io/tutorial/
...
- UW extension: in addition to annotations in comments, support
  special /_>>> _/ comments to hide multiple tokens.
...
Bug fixes
Fixed the annotated JDK to match OpenJDK 6 - Added missing methods and corrected class hierarchy
...
Locking checker - Add subtype checking for Holding - Treat constructors as synchronized methods
...
Bug fixes
Corrected method declarations in JDK skeleton files - bug resulted in a runtime error
...
Fixed bugs when type-checking annotations and enums - bug results in null-pointer exception
...
available online at https://eisop.github.io/api/ .
