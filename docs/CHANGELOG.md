...
As an extension to the fix for eisop#270, we now allow parsing multiple
stub files at the same time. This should make `AnnotatedTypeFactory.getDeclAnnotations`
