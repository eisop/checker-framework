...
def check_all_links(
    ...
    if cf_version_of_broken_link_to_suppress != "":
        additional_param = (
            "--suppress-broken 404:https://eisop.github.io/checker-framework-"
            + cf_version_of_broken_link_to_suppress
            + ".zip"
        )
...
def main(argv):
    ...
    if test_mode:
        ...
        msg = (
            ...
            + "\n"
            + "  https://eisop.github.io/checker-framework-"
            + new_cf_version
            + ".zip\n"
            + "  https://eisop.github.io/annotation-file-utilities/annotation-tools-"
            + new_cf_version
            + ".zip\n"
            + "\n"
            ...
            + new_cf_version
            + "\n"
            + "* For the description, insert the latest Checker Framework changelog entry (available at https://eisop.github.io/CHANGELOG.md). Please include the first line with the release version and date.\n"
            ...
            + new_cf_version
            + "\n"
            + "* For the description, insert the latest Annotation File Utilities changelog entry (available at https://eisop.github.io/annotation-file-utilities/changelog.html). Please include the first line with the release version and date. For bullet points, use the * Markdown character.\n"
