 ...
 * @compile/fail/ref=WithStub.out -XDrawDiagnostics -processor org.checkerframework.checker.nullness.NullnessChecker -Anomsgtext -AonlyAnnotatedFor -Astubs=SuppressionTest.astub SuppressionTest.java
 *
 ...
 * @compile/fail/ref=WithStubConservativeSource.out -XDrawDiagnostics -processor org.checkerframework.checker.nullness.NullnessChecker -Anomsgtext -AuseConservativeDefaultsForUncheckedCode=source -Astubs=SuppressionTest.astub SuppressionTest.java
 */
