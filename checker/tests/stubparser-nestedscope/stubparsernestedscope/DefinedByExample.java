...
// in the default package, masking the bug this test pins (see AnnotationFileParser's
// Elements.getTypeElement(String), which resolves canonical names for nested types directly).
