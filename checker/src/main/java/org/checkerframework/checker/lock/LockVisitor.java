...
public class LockVisitor extends BaseTypeVisitor<LockAnnotatedTypeFactory> {
    ...
    protected void commonAssignmentCheck(
        ...
        // appropriate
        // locks are held before the information in the @GuardedBy annotation is lost in the
        // assignment
        // to the variable annotated with @GuardSatisfied. See the discussion of @GuardSatisfied in
        // the
    ...
    public Void visitMethodInvocation(MethodInvocationTree node, Void p) {
        ...
        if (methodElement != null) {
            ...
            // expressions
            // are effectively final.  TODO: generalize to any expression. This is currently
            // designed only
    ...
    private void ensureExpressionIsEffectivelyFinal(final ExpressionTree lockExpressionTree) {
        ...
        // design, it
        // is easier to be certain that an error will always be issued if a tree kind is not
        // recognized.
