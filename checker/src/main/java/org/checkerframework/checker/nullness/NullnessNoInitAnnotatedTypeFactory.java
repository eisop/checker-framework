...
public class NullnessNoInitAnnotatedTypeFactory
    ...
    public NullnessNoInitAnnotatedTypeFactory(BaseTypeChecker checker) {
        ...
        if (checker.getUltimateParentChecker().getBooleanOption("jspecifyNullMarkedAlias", true)) {
            ...
            // Name the nullness-only subchecker ("nullnessnoinit"); "nullness" would pull in the
            // Initialization and KeyFor subcheckers, which JSpecify does not define.
            ...
            // caveat, as the @DefaultQualifier half above; both halves must agree.
