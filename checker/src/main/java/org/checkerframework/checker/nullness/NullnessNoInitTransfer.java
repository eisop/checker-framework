...
public class NullnessNoInitTransfer
    extends CFAbstractTransfer<NullnessNoInitValue, NullnessNoInitStore, NullnessNoInitTransfer> {
   ...
   * method call or constructor invocation, arguments of the invocation (including the receiver) are
   ...
   */
  @Override
  protected TransferResult<NullnessNoInitValue, NullnessNoInitStore> strengthenAnnotationOfEqualTo(
  ...
  public TransferResult<NullnessNoInitValue, NullnessNoInitStore> visitArrayAccess(
    ...
    TransferResult<NullnessNoInitValue, NullnessNoInitStore> result = super.visitArrayAccess(n, p);
  ...
  public TransferResult<NullnessNoInitValue, NullnessNoInitStore> visitInstanceOf(
    ...
    TransferResult<NullnessNoInitValue, NullnessNoInitStore> result = super.visitInstanceOf(n, p);
  ...
  public TransferResult<NullnessNoInitValue, NullnessNoInitStore> visitMethodAccess(
    ...
    TransferResult<NullnessNoInitValue, NullnessNoInitStore> result = super.visitMethodAccess(n, p);
  ...
  public TransferResult<NullnessNoInitValue, NullnessNoInitStore> visitFieldAccess(
    ...
    TransferResult<NullnessNoInitValue, NullnessNoInitStore> result = super.visitFieldAccess(n, p);
   ...
   * arguments that are passed to non-null parameters in a method call or constructor invocation are
   * unsoundly assumed to be non-null after the invocation.
   *
