...
public class NullnessNoInitVisitor extends BaseTypeVisitor<NullnessNoInitAnnotatedTypeFactory> {
   ...
   */
  private void checkSwitchNullRedundant(ExpressionTree expression, List<? extends CaseTree> cases) {
  ...
  public Void visitConditionalExpression(ConditionalExpressionTree tree, Void p) {
    ...
    this.commonAssignmentCheck(condThen, tree.getTrueExpression(), "conditional.type.incompatible");
