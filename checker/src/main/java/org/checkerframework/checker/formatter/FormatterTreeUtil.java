...
public class FormatterTreeUtil {
    ...
    public static class Result<E> {
        ...
        public class FormatCall {
             ...
             *
             * @return an error description if the format string is not annotated as
             *     {@code @Format}, or null if it is
             */
            ...
            /**
             * Returns the types of the arguments to the call. Use {@link #isValidArgument} and
             * {@link #isArgumentNull} to work with the result.
             *
            ...
            /**
             * Checks if the type of an argument returned from {@link #getArgTypes()} is valid for
             * the passed ConversionCategory.
             *
            ...
            /**
             * Checks if the argument returned from {@link #getArgTypes()} is a {@code null}
             * expression.
             *
             * @param type a type
        ...
        public final void failure(
                Result<?> res, @CompilerMessageKey String msgKey, Object... args) {
        ...
        /**
         * Takes a syntax tree element that represents a {@link InvalidFormat} annotation, and
         * returns its value.
         *
         * @param anno an InvalidFormat annotation
         * @return its value() element/field
