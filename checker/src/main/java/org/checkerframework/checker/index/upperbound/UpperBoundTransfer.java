...
public class UpperBoundTransfer extends IndexAbstractTransfer {
   ...
   * {@link #propagateToSubtractionOperands(UBQualifier.LessThanLengthOf, NumericalSubtractionNode,
   * TransferInput, CFStore)}, and {@link
   ...
   * #propagateToAdditionOperand(UBQualifier.LessThanLengthOf, Node, Node, TransferInput, CFStore)}
   * and {@link #propagateToMultiplicationOperand(UBQualifier.LessThanLengthOf, Node, Node,
   * TransferInput, CFStore)}, this method takes the NumericalSubtractionNode instead of the two
   * operand nodes. This implements case 4.
   *
