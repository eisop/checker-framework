...
public class RegexVisitor extends BaseTypeVisitor<RegexAnnotatedTypeFactory> {
  ...
  public RegexVisitor(BaseTypeChecker checker) {
    ...
    this.matchResultGroup = TreeUtils.getMethod("java.util.regex.MatchResult", "group", env, "int");
    this.matchResultStart = TreeUtils.getMethod("java.util.regex.MatchResult", "start", env, "int");
    this.patternCompile =
        TreeUtils.getMethod("java.util.regex.Pattern", "compile", env, "java.lang.String", "int");
