...
For some analysis, lub can be computed at the store level, and no need
to compute it at the abstract value level. For example, in LiveVariable analysis
(\autoref{sec:live_variable}), we need to compute the lub of successors' stores, and
it is meaningless to further calculate the lub of two individual live variables in a smaller granularity.
