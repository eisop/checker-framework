...
\label{sec:UnusedAbstractValue_classes}
...
UnusedAbstractValue implements the leastUpperBound method in a way it
...
further calculate the lub of two individual live variables in a smaller granularity.
...
public class UnusedAbstractValue implements AbstractValue<UnusedAbstractValue> {
    ...
    public UnusedAbstractValue leastUpperBound(UnusedAbstractValue other) {
        throw new BugInCF("lub of UnusedAbstractValue gets called!");
    }
}
\end{verbatim}
