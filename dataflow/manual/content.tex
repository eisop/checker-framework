...
\textbf{Abstract values.} A class \code{ReachingDefinitionsValue} is used as an
abstract value, which can only wrap \code{AssignmentNode}. The reaching definitions
...
\code{reachingDefSet} which contains a set of \code{ReachingDefinitionsValue}s. The store defines methods
...
be killed in the store when its lhs is same as that of the new generated value, and the new
