 ...
 */
public class ReachingDefinitionsNode {
     ...
     */
    public ReachingDefinitionsNode(AssignmentNode n) {
        this.def = n;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        if (!(obj instanceof ReachingDefinitionsNode)) {
            return false;
        }
        ReachingDefinitionsNode other = (ReachingDefinitionsNode) obj;
