...
public class PurityChecker {
    ...
    protected static class PurityCheckerHelper extends TreePathScanner<Void, Void> {
        ...
        public Void visitNewClass(NewClassTree node, Void ignore) {
            ...
            // not
            // within a catch block that could catch an exception that the statement throws.  For
            // example,
            // EXPR can be object creation (a "new" expression) or can call a non-deterministic
            // method.
            //
            ...
            // is not
            // contained within any try statement that has a catch clause.  (There is no need to
            // check the
