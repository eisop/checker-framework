...
public class TypeInformationPresenter {
  ...
  private class TypeInformationReporter extends TreeScanner<Void, Void> {
    ...
    public Void visitTypeParameter(TypeParameterTree tree, Void unused) {
      reportTreeType(
          tree, atypeFactory.getAnnotatedTypeFromTypeTree(tree), MessageKind.DECLARED_TYPE);
    ...
    public Void visitAssignment(AssignmentTree tree, Void unused) {
      ...
      reportTreeType(
          tree, atypeFactory.getAnnotatedType(tree.getExpression()), MessageKind.ASSIGN_RHS_TYPE);
