...
public class UseOfVariable extends AbstractType {
    ...
    public void addBound(Constraint parent, BoundKind kind, AbstractType bound) {
        if (!hasPrimaryAnno) {
            ...
            // be
            // ignored. Also, set to bottom or top, unless the bound is a type variable. This way if
            // all
            // the bounds of a variable have annotations to be ignored, the instantiation of that
            // variable
