...
public abstract class AbstractTypeInformationPresenter implements TypeInformationPresenter {
  ...
  /**
   * The {@link GenericAnnotatedTypeFactory} for the current analysis. null if the factory is not an
   * instance of {@link GenericAnnotatedTypeFactory}; otherwise, {@code factory} and {@code
  ...
  protected abstract class TypeInformationReporter extends TreePathScanner<Void, Void> {
    ...
    public Void visitTypeParameter(TypeParameterTree tree, Void unused) {
      reportTreeType(
          tree, atypeFactory.getAnnotatedTypeFromTypeTree(tree), TypeOccurrenceKind.DECLARED_TYPE);
    ...
    public Void visitMethod(MethodTree tree, Void unused) {
      reportTreeType(tree, atypeFactory.getAnnotatedType(tree), TypeOccurrenceKind.DECLARED_TYPE);
    ...
    public Void visitMethodInvocation(MethodInvocationTree tree, Void unused) {
      reportTreeType(
          tree, atypeFactory.methodFromUse(tree).executableType, TypeOccurrenceKind.USE_TYPE);
    ...
    public Void visitMemberReference(MemberReferenceTree tree, Void unused) {
      ...
      reportTreeType(
          tree, atypeFactory.getFnInterfaceFromTree(tree).first, TypeOccurrenceKind.USE_TYPE);
