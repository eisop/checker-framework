...
public class DependentTypesHelper {
  ...
  public void atParameterizedTypeUse(
    ...
    StringToJavaExpression stringToJavaExpr =
        stringExpr ->
            StringToJavaExpression.atTypeDecl(stringExpr, typeUse, atypeFactory.getChecker());
      ...
      stringToJavaExpr =
          stringExpr ->
              StringToJavaExpression.atMethodInvocation(
                  stringExpr, (MethodInvocationTree) tree, atypeFactory.getChecker());
      if (debugStringToJavaExpression) {
        System.out.printf(
  ...
  public void atTypeDecl(AnnotatedTypeMirror type, TypeElement typeElt) {
    ...
    StringToJavaExpression stringToJavaExpr =
        stringExpr ->
            StringToJavaExpression.atTypeDecl(stringExpr, typeElt, atypeFactory.getChecker());
    if (debugStringToJavaExpression) {
  ...
  public void atExpression(AnnotatedTypeMirror annotatedType, ExpressionTree expressionTree) {
    ...
    StringToJavaExpression stringToJavaExpr =
        stringExpr -> StringToJavaExpression.atPath(stringExpr, path, atypeFactory.getChecker());
    if (debugStringToJavaExpression) {
      System.out.printf(
  ...
  protected AnnotationMirror buildAnnotation(
    ...
    AnnotationBuilder builder =
        new AnnotationBuilder(
            atypeFactory.getProcessingEnv(), AnnotationUtils.annotationName(originalAnno));
  ...
  private void checkTypeVariablesForErrorExpressions(
    ...
    for (int i = 0; i < methodType.getTypeVariables().size(); i++) {
      ...
      StringToJavaExpression stringToJavaExpr =
          stringExpr ->
              StringToJavaExpression.atMethodBody(stringExpr, tree, atypeFactory.getChecker());
      if (debugStringToJavaExpression) {
        System.out.printf(
