...
public class AnnotationEqualityVisitor extends DoubleJavaParserVisitor {
    ...
    public <T extends Node> void defaultAction(T node1, T node2) {
        ...
        // in
        // where comments appear, or whether they appear at all. So, to check if two nodes have the
        // same
        // annotations we create copies with all comments removed and compare their lists of
        // annotations
        // directly.
