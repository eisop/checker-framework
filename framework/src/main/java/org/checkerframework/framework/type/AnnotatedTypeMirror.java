...
public abstract class AnnotatedTypeMirror implements DeepCopyable<AnnotatedTypeMirror> {
  ...
  /**
   * A version of {@link #hasAnnotationRelaxed(AnnotationMirror)} that considers annotations on the
  ...
  public static class AnnotatedExecutableType extends AnnotatedTypeMirror {
     ...
     * accepts a variable number of arguments and the {@link #paramTypes} has not been expanded yet.
     * This type needs to be stored in the field to avoid being affected by calling {@link
    ...
    /**
     * Sets the parameter types of this executable type, excluding the receiver.If paramTypes has
     * been computed and this type is a varargs method, computes and store {@link #varargType}
     * before calling this method, @see {@link #varargType}
     *
          ...
          for (TypeMirror t : underlyingParameterTypes) {
            if (t.getKind() == TypeKind.ERROR) {
              ...
              throw new ErrorTypeKindException(
                  ...
                  element, element.getEnclosingElement(), t, t.getKind(), t.getClass());
            }
     ...
     *
     * <p>This method computes {@link #varargType} using the {@link #paramTypes} of this executable
     * type. To use the {@link #paramTypes} from different executable type, use {@link
     ...
     *
     * @param types an unmodifiable list of type variables of this executable type to be captured by
     *     this method
     */
