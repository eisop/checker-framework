 ...
 * NullType ], Store[ extends @UnknownPropertyKey CFAbstractStore<Value[ extends @UnknownPropertyKey
 ...
 * extends @UnknownPropertyKey CFAbstractValue<Value[ extends @UnknownPropertyKey
 * CFAbstractValue<Value> super @Bottom NullType ]> super @Bottom NullType ], Store> super @Bottom
 * NullType ]> super @Bottom NullType ], TransferFunction> super @Bottom NullType ]> super @Bottom
 * NullType ]> super @Bottom NullType ]
 */
