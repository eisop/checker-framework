...
public final class TreeUtils {
     ...
     * alone. An identifier cannot be: it is a type use in {@code class C extends Base {}} but an
     * expression in {@code base = null}. This method resolves that ambiguity by asking what the
