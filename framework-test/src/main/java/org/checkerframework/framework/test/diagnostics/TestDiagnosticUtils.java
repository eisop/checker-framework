...
public class TestDiagnosticUtils {
   ...
   * message" is turned into {@code IPair.of(":49: My error message", Path("foo/bar/Baz.java"))}. If
   * the file path cannot be determined, it uses {@code ""}. This is necessary to make writing the
   * expected warnings easy.
   *
